...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func didBeginContact(contact: SKPhysicsContact) {
        ...
        if (body1.categoryBitMask == PhysicsCategories.Player && body2.categoryBitMask == PhysicsCategories.Life){
            addALife()
            spawnLifeExplosion(body1.node!.position)
            body2.node?.removeFromParent()
        }
        
        if (body1.categoryBitMask == PhysicsCategories.Player && body2.categoryBitMask == PhysicsCategories.Ice){
            spawnIceExplosion(body1.node!.position)
            body2.node?.removeFromParent()
    ...
    //.............................................................................................. this function will run whenever we touch the screen
    ...
    override func touchesMoved(touches: Set<UITouch>, withEvent event: UIEvent?) {
        ...
        for touch: AnyObject in touches{
            ...
            if currentGameState == gameState.inGame || currentGameState == gameState.freezeGame || currentGameState == gameState.introGame{
